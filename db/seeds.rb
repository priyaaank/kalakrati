...
rose_bottle = Product.new(name: "Rose bottle with white flowers", description: "Rose bottle with white flowers", code: "Bottle13", price: 1200, category: glass_bottles)
rose_bottle.images << Image.new(url: "product/glass/rose_bottle_with_white_flowers.jpg", primary: true)
rose_bottle.save!

brown_bottle = Product.new(name: "Brown bottle with flowers", description: "Brown bottle with flowers", code: "Bottle12", price: 1000, category: glass_bottles)
...
blue_bottle = Product.new(name: "Blue bottles with gems", description: "Blue bottle with gems", code: "Bottle02", price: 900, category: glass_bottles)
...
green_bottle = Product.new(name: "Green bottle with rope", description: "Green bottle with rope", code: "Bottle22", price: 500, category: glass_bottles)
...
blue_basket = Product.new(name: "Blue basket", description: "Blue basket for dry contents", code: "Basket12", price: 500, category: paper_crafts)
